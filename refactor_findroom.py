...
def fix_fragment(filepath, layout_name, class_name, fragment_name):
    ...
    oncreate_pattern = r'(?:@Override\s+)?protected void onCreate\(\s*Bundle savedInstanceState\s*\)\s*\{'
    ...
    # finish() -> requireActivity().onBackPressed()
...
def main():
    ...
    fix_fragment(os.path.join(base_dir, "FindRoomActivity.java"), "activity_find_room", "FindRoomActivity", "FindRoomFragment")
